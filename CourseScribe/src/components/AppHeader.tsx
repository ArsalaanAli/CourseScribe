          ...
          <div className="relative flex flex-row items-center justify-between gap-6 py-2">
            ...
            {status === "authenticated" ? (
              <div className=" flex w-auto flex-row pr-4 pt-0 text-gray-600 dark:text-gray-300">
                ...
                <Link
                  href="/upload"
                  className="relative mx-4 flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95"
                >
                  <span className="relative cursor-pointer text-lg font-medium text-white">
                    Upload
                  </span>
                </Link>
              </div>
